    ...
    <AuthBase title="Log in to your account"
        ...
        <form @submit.prevent="submit"
            ...
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    <div
                        ...
                        <TextLink v-if="canResetPassword"
                            ...
                            class="text-sm text-[#F08519] hover:underline"
                            :tabindex="5">
                            Forgot password?
                        </TextLink>
                    </div>
                ...
                <Button type="submit"
                    class="mt-4 w-full bg-[#F08519] text-white hover:bg-[#F08519]/90"
                    :tabindex="4"
            ...
            <div
                ...
                <TextLink :href="route('register')"
                    class="font-semibold text-[#F08519] hover:underline"
